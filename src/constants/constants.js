...
export const AUTHORIZATION_CODE = `authorization_code`; //может отрефакторить?
export const APPLICATION_JSON = `application/json`; //может отрефакторить?
export const TOKEN = `TOKEN`;

export const SEPARATOR_CODE = `?code=`;
export const BEARER = `Bearer `; //можно отрефакторить?
